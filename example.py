...
if __name__ == "__main__":
    observations = {param_name: rng.random(N) * (UB - LB) + LB for param_name in param_names}
    observations[obj_name] = func(X=observations)
    print(global_hpi(observations, bounds, param_names, obj_name, gamma=0.1))
    print(local_hpi(observations, bounds, param_names, obj_name, gamma_local_top=0.01, gamma_local=0.1))
